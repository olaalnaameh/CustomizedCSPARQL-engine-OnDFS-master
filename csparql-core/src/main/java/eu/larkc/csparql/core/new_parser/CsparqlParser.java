...
private static String sparqlQueryTranslated="PREFIX lld:   <http://linkeddata.com/ontology#> ";
    ...
    if (jj_2_12(5)) {
      ...
      while (true) {
        if (jj_2_11(5)) {
          t = jj_consume_token(SPACE);
                              sparqlQuery = sparqlQuery + t.image ;
                              if(predicate.equals("rdf:type") || predicate.equals("a") || predicate.equals("om-owl:procedure") || predicate.equals("om-owl:observedProperty"))
                                  {               
                            	  moleculeOn =false;	
                                	  //System.out.println("Create Observation Molecule : "+current_word);
                                	   object=current_word;
                                    	...
                                    	{	
                                    		sparqlQueryTranslated = sparqlQueryTranslated+" "+subject+"M lld:hasObservation "+subject+".";
                                    		sparqlQueryTranslated = sparqlQueryTranslated + t.image;
                                		...
                                		predicate="";
                                		current_word="";
                                  }//End of if(predicate.equals("rdf:type") || predicate.equals("a") || predicate.equals("om-owl:procedure") || predicate.equals("om-owl:observedProperty"))
                                 	...
                                 	{	
                                 		sparqlQueryTranslated = sparqlQueryTranslated+" "+object+"M lld:hasObservation "+object+".";
                                 		sparqlQueryTranslated = sparqlQueryTranslated + t.image;
          ...
          while (true) {
            ...
            case SINGLELETTERTEXT:
              ...
              else if(current_word.equals("OPTIONAL") || current_word.equals("UNION")){                                	  
            	  sparqlQueryTranslated = sparqlQueryTranslated + current_word ;
            	  //sparqlQueryTranslated = sparqlQueryTranslated + t.image;
            	  current_word="";
              }//End of else if(current_word.equals("OPTIONAL"))
              else if(current_word.equals("GROUP")){
